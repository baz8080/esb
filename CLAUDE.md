...
| The stale banner trips at 28h, not 24h: daily push jitter makes 24h false-alarm on evening rebuilds, and a real miss is 30h+ by the next morning build | `notes/staleness.md` |

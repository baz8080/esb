...
| The national tiles carry no jargon — no "CML", "annualised" or "unplanned"; `54` · "customer-years off supply" puts the unit in the label, because a 24px value gets a 150px column | `notes/design-alignment.md` § The tiles say what they mean (2026-08-28) |

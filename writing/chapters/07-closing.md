# 7. Closing: two feeds, two sites, one discipline
*~9 min read · with the side-by-side table and a glossary*

*Where we are:* the end of the account, on 27 August 2026, with the repository at pull
request #20 — 98 commits, 189 tests, and twenty-six days of continuously collected data.
...
against the 95% ESB's charter aims for; nine counties met the aim, three took an F against
it, and exactly one outage in the whole corpus ran past the 24-hour compensation mark
(`notes/grading.md`, 17 Aug 2026). And the average interrupted customer was back in about an
hour and a half — this pipeline's CAIDI of 92.2 minutes sits within 8% of ESB's own
published 85.1 (chapter 4b), which is the strongest external check either of these sibling
sites has ever had.

The honest answer carries its dates, though. This is 26 days of high summer, collected by
...
| Who was affected | Census population within a 500 m assumption — the feed says nothing | ESB's own customer count — biased 1.3×, enveloped, never summed |

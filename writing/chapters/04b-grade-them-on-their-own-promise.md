...
built availability out of Census person-hours and drew its own A to F thresholds - defensible,
...
> hours, with A at ESB's own published 95% aim, then B at 90%, C at 80%, D at 70% (an E at 60%
> joins them in chapter 7b, splitting the old F band and moving nothing above it) - so a
...
between E and F). One outage in the whole corpus crossed the 24-hour mark at which the charter
pays compensation.
...
- `notes/grading.md` "The published prior art" (17 Aug 2026): the Customer Charter 4-hour/95%
  ...
  SAIDI minutes.
- `notes/grading.md` "The grade" and "Why not Customer Minutes Lost" (17 Aug 2026): A to F

...
| The app's county view links to `c/<slug>.html` from its own line under the heading; the wording names the difference (one month here, every month there) rather than calling itself a permalink | `notes/design-alignment.md` § The county page got a way in from the app |

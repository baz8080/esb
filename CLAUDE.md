...
| The merged-id ceiling is two numbers, because a staged planned job is published one id per feeder section (21 at Ramstown) where a fault's family peaks at 7: faults under 12, planned works under 30 | `notes/grading.md` § The id ceiling is two numbers, not one (2026-09-20) |

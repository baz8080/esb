...
and short days labelled. From here on, nothing in this repository changes how the numbers are
*computed*. The remaining chapters are about the frame around them: sharing a design system
with two sibling sites, learning to speak to a reader, going down a level to the town, and
choosing the units and the letters those numbers are published in.

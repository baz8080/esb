...
| The national tiles carry no jargon: `154` · "customer minutes lost a year" (not "CML", "annualised" or "unplanned" — but *a year* stays, or the tile understates by 12×) and `54` · "customer-years off supply", the unit in the label because 24px values get a 150px column | `notes/design-alignment.md` § The tiles say what they mean (2026-08-28) |

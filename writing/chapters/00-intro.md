...
| **7** | *Closing* | What the site can and cannot say, the two sites side by side in one table, and a glossary. |

## How it was built, said once

Like the water site, this project was written with an AI assistant — Claude, in Anthropic's
Claude Code — from the first commit. Sixty of the repository's 98 commits carry a
...
carries no county. A county-month is graded A–F on the share of its fault-interrupted

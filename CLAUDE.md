...
| An outage still listed at the last poll carries `ongoing` as the case record's twelfth field, ships its estimate, and reads "still out when last checked" plus what ESB has said (expected back by, past ESB's estimate of, no estimate published); no span, because its end is the horizon. Planned works keep their schedule wording | `notes/design-alignment.md` § An outage still out says so (2026-09-05) |
